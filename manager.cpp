...
Manager::Manager(): mapProgramme(new QMap<QString, QString>),
                    mapVariable(new QMap<QString, QString>),
                    stringListProgrammes(new QStringList),
                    stringListVariables(new QStringList),
                    pile(new Pile(this))
{
